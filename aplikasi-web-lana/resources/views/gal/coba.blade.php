    ...
    <head>
        ...
        <style>
            ...
            .gambar-kotak {
                ...
                overflow: hidden;
                /* Menghilangkan konten yang melebihi batas kotak */
                position: relative;
                /*Memastikan posisi relatif untuk menempatkan teks*/
                cursor: pointer;
                /*Menetapkan kursor sebagai pointer untuk menunjukkan interaktif*/
                /* display: grid; */
            ...
            .gambar-kotak img {
                width: 100%;
                /* Untuk memastikan gambar mengisi kotak */
                height: auto;
                /* Untuk menjaga aspek rasio gambar */
            }
            ...
            .teks-atas {
                ...
                position: absolute;
                inset: 0;
                /* Ini menggantikan top: 0; left: 0; right: 0; */
            ...
            .modal-body img {
                ...
                height: auto;
                object-fit: contain;
                /* Atau gunakan 'cover' jika ingin gambar mengisi seluruh area dengan mempertahankan aspek rasio */
            }
        </style>
    </head>
                ...
                @foreach ($sertif as $index => $item)
                    @if ($item->kategori == 'sertifikat')
                        <div class="flex w-25 h-25 p-3 col-md-4 justify-content-center">
                            <div class="gambar-kotak" style="" data-bs-toggle="modal"
                                data-bs-target="#modalSertifikat{{ $index }}">
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="modalSertifikat{{ $index }}" tabindex="-1"
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        ...
                                        <div class="teks-atas d-flex justify-content-between">
                                            <p class="my-auto"> {{ $item->judul_kegiatan }}</p>
            ...
            <div class="d-flex p-2 flex-wrap">
                @foreach ($sertif as $index => $item1)
                    @if ($item1->kategori == 'kegiatan')
                        <div class="flex w-25 h-25 p-3 col-md-4 justify-content-center">
                            <div class="gambar-kotak" style="" data-bs-toggle="modal"
                                data-bs-target="#modalKegiatan{{ $index }}">
                                <img class="img-fluid" src="{{ asset('storage/images/' . $item1->foto) }}"
                                    alt="Sertifikat 1">
                                <div class="teks-atas">Teks Atas</div>
                                <div class="teks-bawah">Teks Bawah</div>
                            </div>
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="modalKegiatan{{ $index }}" tabindex="-1"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    <div class="modal-body">
